-- ============================================================
-- 【已废弃】VCH_TRIAL 批量试用脚本。当前计费不再使用 VCH_TRIAL（见 crm-order-design.md / 迁移 20260413143000）。
-- 保留文件仅作历史参考；新环境勿执行。
-- ============================================================
...
FROM (VALUES
  ...
  ('50b796ed-e44d-4999-98a3-cf8a50875030'::uuid, '2026-02-10 04:19:23.660368+00'::timestamptz),
  ...
  ('6063d326-721d-4074-a5c4-a46c357a6c84'::uuid, '2026-02-10 07:15:50.16672+00'::timestamptz),
  ('6985ec23-6c54-46b1-86e5-7fe311d5e0a5'::uuid, '2026-02-09 16:36:21.466321+00'::timestamptz),
  ('6a308b44-181d-4af7-a4ff-12643676b200'::uuid, '2026-02-10 14:56:26.452131+00'::timestamptz),
  ...
  ('a555c2cc-d1bf-4c4e-a838-5f552f83f59d'::uuid, '2026-02-10 15:18:05.448959+00'::timestamptz),
  ...
  ('ecb348f8-a458-49d3-a49e-6c5265bc5c5d'::uuid, '2026-02-10 21:18:01.123458+00'::timestamptz),
  ('f26621d5-cd51-416b-a8d0-bbcb6f0cb17d'::uuid, '2026-02-10 11:35:59.652285+00'::timestamptz),
  ('fd0034ff-fe06-4159-a9c2-a955945f1a2c'::uuid, '2026-02-10 15:01:22.166229+00'::timestamptz),
